...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { driving_distance: @event_type.driving_distance, name: @event_type.name, volunteer_hours: @event_type.volunteer_hours }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { driving_distance: @event_type.driving_distance, name: @event_type.name, volunteer_hours: @event_type.volunteer_hours }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
